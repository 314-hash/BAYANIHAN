...
## 💱 Phase 8: DEX Listing & Localized Swap Widget Integration (July 2026 Update)

We developed and integrated a localized Swap Widget directly into the Bayanihan Web Portal frontend that connects with the PancakeSwap DEX Router protocol. This allows users to buy and sell `BAYANI` utility tokens directly on the platform:

### 1. Unified Interface Layout
*   **Navigation Tabs:** Integrated a new "Swap" button inside both the desktop navigation bar and the mobile bottom navigation menu in [`index.html`](file:///c:/Users/janla/Bayanihan/frontend/index.html).
*   **Card Widget:** Designed a custom Swap Card panel complete with numerical amount inputs, token balance counters, token selectors (BNB/BAYANI), a direction toggle button (arrow flip), and detailed exchange rate quotation previews.
...
*   **Automatic Network Resolvers:** Mapped the PancakeSwap V2 Router contract coordinates across BSC Mainnet (`0x10ED43C718714eb63d5aA57B78B54704E256024E`) and BSC Testnet (`0x9Ac64Cc6e4415144C455BD8E4837Fea55603e5c3`).
